...
impl GDArray {
    ...
    pub fn hash(&mut self) -> i32 {
        unsafe { godot_array_hash(&mut self._array) }
    }
    ...
    pub fn invert(&mut self) {
        unsafe { godot_array_invert(&mut self._array) }
    }
    ...
    pub fn remove(&mut self, index: i32) {
        unsafe { godot_array_remove(&mut self._array, index) }
    }

    pub fn size(&mut self) -> i32 {
        unsafe { godot_array_size(&mut self._array) }
    }

    pub fn resize(&mut self, new_size: i32) {
        unsafe { godot_array_resize(&mut self._array, new_size) }
    }
    ...
    fn sort(&mut self) {
        unsafe { godot_array_sort(&mut self._array) }
    }
...
impl Drop for GDArray {
    fn drop(&mut self) {
        unsafe { godot_array_destroy(&mut self._array) }
    }
}
